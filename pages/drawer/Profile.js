  ...
  componentDidMount = async () => {
    ...
    render() {
      return (
        ...
        <Image style={{width:150, height:150, marginTop:40, marginBottom:30, marginLeft:20, flexDirection:'row' }}
        ...
        />
          ...
          <TouchableOpacity style={{backgroundColor: '#1c313a',width: 120, height:50, marginTop:-80, paddingVertical: 12, borderRadius: 5, marginLeft:250}} onPress={this.login}>
